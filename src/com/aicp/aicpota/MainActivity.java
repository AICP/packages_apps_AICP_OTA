        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Snackbar.make(itemView, R.string.permission_granted_dialog_title ,Snackbar.LENGTH_LONG).show();
                } else {
                    Snackbar.make(itemView, R.string.permission_not_granted_dialog_title ,Snackbar.LENGTH_LONG).show();
                }
            return;
        }
    }
