...
package com.schism.schismota.updater.server;
...
import com.schism.schismota.updater.Server;
import com.schism.schismota.updater.UpdatePackage;
import com.schism.schismota.updater.Updater.PackageInfo;

public class SCHISMServer  implements Server {

    private static final String URL = "http://downloads.theschismrom.com/update.php?device=%s";
